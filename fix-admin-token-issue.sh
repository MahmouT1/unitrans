...
# Fix the authentication logic to handle missing adminToken
echo "🔧 Fixing authentication logic..."
    ...
    useEffect(() => {
        const checkAuth = () => {
            try {
                ...
                // Check if user exists and has admin role (with or without adminToken)
...
# Also fix the admin layout to handle missing adminToken
...
echo ""
echo "✅ Admin token issue fix completed!"
echo "🌍 Test your project at: https://unibus.online/admin/users"
echo "📋 Student Search page should now work with admin accounts"
