...
echo "🔧 إصلاح Git Merge Conflict النهائي"
echo "=================================="
...
echo "🔍 فحص merge conflict markers في students.js:"
...
echo "🔧 إزالة merge conflict markers:"
...
echo ""
echo "🔍 3️⃣ فحص الملف بعد الإصلاح:"
echo "=========================="

echo "🔍 فحص merge conflict markers بعد الإصلاح:"
grep -n "<<<<<<< HEAD" backend-new/routes/students.js || echo "No merge conflict found"
grep -n "=======" backend-new/routes/students.js || echo "No merge conflict found"
grep -n ">>>>>>>" backend-new/routes/students.js || echo "No merge conflict found"
...
echo ""
echo "🎉 تم إصلاح Git Merge Conflict!"
