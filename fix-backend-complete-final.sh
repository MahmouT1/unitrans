...
echo "🔧 إصلاح Backend نهائياً - الحل الكامل"
echo "===================================="
...
pm2 logs unitrans-backend --err --lines 10

echo ""
echo "🔧 2️⃣ إصلاح Backend نهائياً:"
echo "=========================="
