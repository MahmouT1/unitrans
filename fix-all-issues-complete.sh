...
echo "🔧 إصلاح جميع المشاكل - الحل الكامل"
echo "=================================="

cd /var/www/unitrans

echo ""
echo "🔍 1️⃣ إصلاح Git Identity:"
echo "======================="

echo "🔧 تعيين Git identity:"
git config --global user.email "admin@unibus.online"
git config --global user.name "Unibus Admin"

echo ""
echo "🔍 2️⃣ حل مشكلة Git Pull:"
echo "======================="
