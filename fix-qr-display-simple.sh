...
echo "🔧 إصلاح عرض QR Code في المتصفح"
echo "================================="
...
echo "🔍 فحص student portal page:"
grep -A 5 -B 5 "generateQRCode" frontend-new/app/student/portal/page.js
