...
echo "🔧 إصلاح Backend Module Error"
echo "============================"

cd /var/www/unitrans

echo ""
echo "🔍 1️⃣ فحص Backend Error:"
echo "======================="
...
pm2 logs unitrans-backend --err --lines 20

echo ""
echo "🔧 2️⃣ إصلاح Module Error:"
echo "======================="
...
echo "🔍 فحص Node.js modules:"
cd backend-new
npm list --depth=0

echo ""
echo "🔧 3️⃣ إعادة تثبيت Dependencies:"
echo "=============================="
