...
echo "🔧 إصلاح QR Generation - السكريپت الصحيح"
echo "======================================"

cd /var/www/unitrans

echo ""
echo "🔍 1️⃣ حل مشكلة Git Divergent Branches:"
echo "===================================="

echo "🔧 حل divergent branches:"
git config pull.rebase false

echo "🔄 محاولة pull مرة أخرى:"
git pull origin main

echo ""
echo "🔍 2️⃣ إصلاح QR Generation API مباشرة:"
echo "==================================="

echo "🔧 إصلاح students/generate-qr API:"
cat > /tmp/qr_fix_direct.js << 'EOF'
...
# Replace the generate-qr endpoint directly
