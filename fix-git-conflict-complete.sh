...
echo "🔧 إصلاح Git Conflict الكامل"
echo "=========================="

cd /var/www/unitrans

echo ""
echo "🔍 1️⃣ فحص Git Status:"
echo "==================="
...
echo ""
echo "🔍 فحص الملفات المتضاربة:"
git diff --name-only --diff-filter=U

echo ""
echo "🔧 2️⃣ حل Git Conflict:"
echo "===================="
...
echo ""
echo "🔍 3️⃣ فحص الملفات بعد Pull:"
echo "=========================="

echo "🔍 فحص students.js:"
ls -la backend-new/routes/students.js
