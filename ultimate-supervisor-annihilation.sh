...
# This script will ULTIMATE ANNIHILATE ALL supervisor functionality
...
# 2. ULTIMATE NUCLEAR OPTION: Destroy EVERYTHING
echo "☢️ ULTIMATE NUCLEAR OPTION: Destroying EVERYTHING..."
rm -rf .next
