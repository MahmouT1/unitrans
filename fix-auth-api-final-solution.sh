...
echo "🔧 إصلاح auth-api routes بشكل نهائي"
echo "================================="
...
echo ""
echo "🔧 2️⃣ إصلاح server.js بشكل نهائي:"
echo "=============================="

echo "🔍 فحص نهاية server.js:"
tail -30 backend-new/server.js

echo ""
echo "🔧 3️⃣ إنشاء server.js جديد مع auth-api routes:"
echo "=========================================="
...
echo "✅ تم إنشاء server.js جديد مع auth-api routes"
...
echo ""
echo "🔧 7️⃣ فحص Backend Logs:"
echo "====================="

echo "🔍 فحص backend logs:"
pm2 logs unitrans-backend --lines 15

echo ""
echo "🔧 8️⃣ إعادة Build Frontend:"
echo "========================="
...
echo ""
echo "🧪 10️⃣ اختبار صفحة Login النهائية:"
echo "=============================="
...
echo ""
echo "🎉 تم إصلاح auth-api routes بشكل نهائي!"
