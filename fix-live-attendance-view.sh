...
echo "🔧 Adding Live Attendance View to Green Card"

cd /home/unitrans/frontend-new

# Backup current file
cp app/admin/attendance/page.js app/admin/attendance/page.js.backup4

# Create enhanced version with live attendance view
...
echo "✅ Live attendance view added to green card!"
